...
export const getProducts = () => {
    return async dispatch => {
        ...
        const fetchData = async () => {
            const response = await axios.get('http://178.216.15.87:8000/api/products');
...
export const getProductDetails = (id) => {
    return async dispatch => {
        ...
        const fetchData = async () => {
            const response = await axios.get(`http://178.216.15.87:8000/api/products/${id}`);
...
export const addProduct = ({ product, token }) => {
    return async dispatch => {
        ...
        const postData = async () => {
            const response = await axios.post('http://178.216.15.87:8000/api/products', product, {
                    headers: {
