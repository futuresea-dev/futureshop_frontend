...
export const getProducts = () => {
    return async dispatch => {
        ...
        const fetchData = async () => {
            const response = await axios.get('https://65.108.74.155:8000/api/products');
...
export const getProductDetails = (id) => {
    return async dispatch => {
        ...
        const fetchData = async () => {
            const response = await axios.get(`https://65.108.74.155:8000/api/products/${id}`);
...
export const addProduct = ({ product, token }) => {
    return async dispatch => {
        ...
        const postData = async () => {
            const response = await axios.post('https://65.108.74.155:8000/api/products', product, {
                    headers: {
